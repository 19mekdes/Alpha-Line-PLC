  ...
  am: {
    translation: {
      ...
      hero: {
        ...
        mottoAmharic: "ዓለምን በማገናኘት፣ መጻኢውን በማብራት",
        title: "አልፋ ላይን ኢንጂነሪንግ ኃላፊነቱ የተወሰነ የግል ማህበር",
        description: "በኢትዮጵያ ውስጥ በውጭ እፅዋት (OSP) ኢንጂነሪንግ እና በኤሌክትሪክ ኃይል ፕሮጀክቶች ላይ የተካነ ደረጃ 1 የምህንድስና ድርጅት።",
        cta1: "አገልግሎቶቻችንን ይመልከቱ",
        cta2: "ዋጋ ይጠይቁ"
      },
      about: {
        title: "ስለ አልፋ ላይን ኢንጂነሪንግ ኃላፊነቱ የተወሰነ የግል ማህበር",
        subtitle: "እኛ ማን ነን",
        profile: "የኩባንያ መገለጫ",
        profileDesc: "አልፋ ላይን ኢንጂነሪንግ ኃላፊነቱ የተወሰነ የግል ማህበር በአዲስ አበባ ፣ ኢትዮጵያ ውስጥ የሚገኝ ቀዳሚ ደረጃ 1 የምህንድስና ድርጅት ነው።",
        mission: "ተልዕኳችን",
      ...
      partners: {
        ...
        alphaLine: "አልፋ ላይን ኢንጂነሪንግ ኃላፊነቱ የተወሰነ የግል ማህበር",
        agt: "ኤጂቲ ኢንጂነሪንግ",
